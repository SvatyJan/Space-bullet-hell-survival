...
public class FleetProjectile : MonoBehaviour
{
    ...
    private FleetShipBehavior fleetShipBehavior;
    ...
    public void Initialize(FleetShipBehavior fleetShipBehavior, SpaceEntity owner, float damage)
    {
        this.fleetShipBehavior = fleetShipBehavior;
        this.owner = owner;
